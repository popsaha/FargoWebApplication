...
{
    [BasicAuthentication]
    public class DenominationAPIController : ApiController
    {
        [HttpGet]
        [Route("api/DenominationAPI/LstDenominations")]
        public IHttpActionResult LstDenominations()
        {
            ...
            try
            {
                ...
                {
                    LstDenominations = DenominationManager.LstDenominations();

                    if (LstDenominations.Count == 0)
                    {
